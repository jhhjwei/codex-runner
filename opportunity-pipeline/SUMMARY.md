...
_Last updated: 2026-08-27 07:11:34 +08:00_

- audit record: `opportunity-pipeline/health/audit/2026-08-27/06.md`
- primary heartbeat: `opportunity-pipeline/health/2026-08-27/06.md`
- primary status: missing
- commercial actions in audited hour: 0 (none)
- enforcement state: RED
- trigger reasons: primary hourly heartbeat missing, primary hourly pipeline commit missing, two consecutive hours without commercial action
